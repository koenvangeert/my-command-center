...
Upstream UI/UX workflow and searchable design guidance. Resolve command paths relative to the skill directory, not the worktree root. OpenForge/Pi instructions in `../SKILL.md` take precedence.
## When to Apply
