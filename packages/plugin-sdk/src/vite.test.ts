...
describe('OpenForge plugin Vite author tooling', () => {
  it('creates exact source aliases for public plugin SDK entrypoints', () => {
    ...
    expect(aliases).toEqual([
      ...
      { find: '@openforge-app/plugin-sdk/ui/IconButton.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/IconButton.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/TextField.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/TextField.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Textarea.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Textarea.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Checkbox.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Checkbox.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Switch.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Switch.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Badge.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Badge.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Panel.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Panel.svelte' },
      ...
      { find: '@openforge-app/plugin-sdk/ui/Select.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Select.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/SearchableSelect.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/SearchableSelect.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Tabs.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Tabs.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/AnchoredMenu.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/AnchoredMenu.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/SplitButton.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/SplitButton.svelte' },
      { find: '@openforge-app/plugin-sdk/ui/Tooltip.svelte', replacement: '/repo/packages/plugin-sdk/src/ui/Tooltip.svelte' },
  ...
  it('creates a record-shaped source alias map for Vitest configs', () => {
    expect(createOpenForgePluginSdkSourceAliasRecord(new URL('file:///repo/'))).toEqual({
      ...
      '@openforge-app/plugin-sdk/ui/IconButton.svelte': '/repo/packages/plugin-sdk/src/ui/IconButton.svelte',
      '@openforge-app/plugin-sdk/ui/TextField.svelte': '/repo/packages/plugin-sdk/src/ui/TextField.svelte',
      '@openforge-app/plugin-sdk/ui/Textarea.svelte': '/repo/packages/plugin-sdk/src/ui/Textarea.svelte',
      '@openforge-app/plugin-sdk/ui/Checkbox.svelte': '/repo/packages/plugin-sdk/src/ui/Checkbox.svelte',
      '@openforge-app/plugin-sdk/ui/Switch.svelte': '/repo/packages/plugin-sdk/src/ui/Switch.svelte',
      '@openforge-app/plugin-sdk/ui/Badge.svelte': '/repo/packages/plugin-sdk/src/ui/Badge.svelte',
      '@openforge-app/plugin-sdk/ui/Panel.svelte': '/repo/packages/plugin-sdk/src/ui/Panel.svelte',
      ...
      '@openforge-app/plugin-sdk/ui/Select.svelte': '/repo/packages/plugin-sdk/src/ui/Select.svelte',
      '@openforge-app/plugin-sdk/ui/SearchableSelect.svelte': '/repo/packages/plugin-sdk/src/ui/SearchableSelect.svelte',
      '@openforge-app/plugin-sdk/ui/Tabs.svelte': '/repo/packages/plugin-sdk/src/ui/Tabs.svelte',
      '@openforge-app/plugin-sdk/ui/AnchoredMenu.svelte': '/repo/packages/plugin-sdk/src/ui/AnchoredMenu.svelte',
      '@openforge-app/plugin-sdk/ui/SplitButton.svelte': '/repo/packages/plugin-sdk/src/ui/SplitButton.svelte',
      '@openforge-app/plugin-sdk/ui/Tooltip.svelte': '/repo/packages/plugin-sdk/src/ui/Tooltip.svelte',
