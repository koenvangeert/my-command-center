...
- [x] 4.4 Obtain a successful same-runner-class CI measurement and compare total and post-build duration with run 34205993615; deliver actual phase timings, capture counts, and remaining bottlenecks, explicitly distinguishing the 13–15 minute estimate from measured performance.
